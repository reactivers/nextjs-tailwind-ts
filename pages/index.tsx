    ...
    return (
        <div id="home-page-container" className="flex justify-center items-center">
            <div className='flex flex-col items-center text-5xl'>
                ...
                <h3 className="text-3xl text-white font-extralight" id="home-page-title">HOME PAGE</h3>
                <h5 className="text-xl text-white font-extralight" id="home-page-env-text">{TEST_VAR}</h5>
            </div>
        </div>
    )
}
